...
export default function Card({ id, direccion, precio, estado, inmobiliaria, tiposPropiedad, imagen }: Propiedades) {
  return (
    <div className="bg-white group relative p-3 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="mb-2 flex justify-between items-center">
        ...
        <span className={`px-2 py-1 rounded text-xs font-semibold ${estado === 'disponible' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>{estado}</span>
      </div>
